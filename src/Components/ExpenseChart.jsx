        ...
        <div className="bg-white rounded-lg shadow-md text-center p-6">
            ...
            <div className="flex justify-center mb-6 space-x-4">
                <button
                    ...
                    className={`flex items-center cursor-pointer px-4 py-2 rounded-md transition-all ${chartType === "pie"
                ...
                <button
                    ...
                    className={`flex items-center cursor-pointer px-4 py-2 rounded-md transition-all ${chartType === "bar"
                            ? "bg-expense text-white"
                            : "bg-gray-100 text-gray-600 hover:bg-gray-200"
                        }`}
                >
